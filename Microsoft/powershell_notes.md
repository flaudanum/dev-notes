...
The policy for the _scope_ `CurrentUser` is `Undefined` therefore no script can be run. This can be changed with
**privileges**:
...
Wrap the script call / cmdlet with parentheses:
